...
render live inline in your coding agent's session through Typebulb's agent mirror (sandboxed,
...
the bulb format, the `tb.*` API, trust, and the local run/inline workflow. Use when the
