...
export function createResolver(cache: PackageCache, http: HttpClient) {
  ...
  const packageService = new PackageService(versionResolver, cdnClient, peerResolver)
...
export { CdnClient, normalizeRelative, ensureLeadingDotSlash, type Semver, type PackageMeta } from './cdnClient.js'
