 ...
 *  Relative tb.fs paths resolve here and are fenced here; tb.dir exposes it to bulb code. */
...
export const bulbAssetsDir = (bulbPath: string) => path.join(bulbDataDir(bulbPath), 'assets')
