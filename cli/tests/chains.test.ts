...
/**
 * The same-name chain rule (TB-Agent-Mirror-Inline.md, Iteration Invariant 4): a consecutive
 * run of same-named inline bulbs folds all but its last; a differently-named or unnamed inline bulb breaks the run.
 */
describe('supersededFlags', () => {
  ...
  it('treats a differently-named inline bulb as a run break', () => {
  ...
  it('never folds unnamed inline bulbs, even adjacent ones', () => {
...
describe('chainPositions', () => {
  it('numbers each inline bulb within its consecutive same-name run', () => {
  ...
  it('treats unnamed inline bulbs as singletons', () => {
