...
export const { info, poll, logInlineStatus, listSessions, searchSessions, sessionPeek, attach, listChildren, openChild, closeChild, composerSend, composerStop, composerNew, composerFiles, composerUiRespond, composerRpc, composerPaste, composerPasteRead, summarizeTurn, shutdownComposer } = createMirror(adapter)
