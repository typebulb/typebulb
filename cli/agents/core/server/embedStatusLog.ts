...
// mirror from scratch and re-forwards every embed's identical outcome (the original pile-up), so a line is
// dropped when it equals the last one accepted for that embed's tag. Distinct states still log: ok vs an
